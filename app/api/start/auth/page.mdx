...
If you'd like to **verify** that callbacks from Skala are legitimate, use the **`scale-callback-auth`** HTTP header.
...
| **Callback Verification** | Uses `scale-callback-auth` header                            |
