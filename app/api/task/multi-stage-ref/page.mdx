...
Multi-stage is our most advanced and flexible task type. It is designed to handle complex full-scene labeling that spans multiple annotation types and modalities. Multi-stage tasks serve as a replacement for Scale’s legacy dependent tasks system, which required using multiple tasks to fully label a scene.
